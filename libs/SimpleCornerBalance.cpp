  ...
  for (int iXi = 0; iXi < mesh->quadrature.size(); ++iXi){
    ...
    for (int iMu = 0; iMu < mesh->quadrature[iXi].nOrd; ++iMu){
      ...
      //  cout << "xi: " << xi << endl;
        ...
        //      cout << "cell: " << outUpstreamR[0] << endl;
         //     cout << "reflected flux: " << endl;
         //     cout << (*aFlux)(iZ+cornerOffset(outUpstreamR[0],1),\
         //     iR,reflectedAngIdx) << endl;
         //     cout << "cell: " << outUpstreamR[1] << endl;
         //     cout << "reflected flux: " << endl;
         //     cout << (*aFlux)(iZ+cornerOffset(outUpstreamR[1],1),\
              iR,reflectedAngIdx) << endl;
         //     cout << endl;
          ...
          //    b = b - upstream;
            ...
            //  cout << "cell: " << outUpstreamZ[0] << endl;
            //  cout << "z boundary flux: " << endl;
            //  cout << (*aFlux)(iZ+borderCellZ,\
            //  iR+cornerOffset(outUpstreamZ[0],0),angIdx) << endl;
            //  cout << "cell: " << outUpstreamZ[1] << endl;
            //  cout << "z boundary flux: " << endl;
            //  cout << (*aFlux)(iZ+borderCellZ,\
            //  iR+cornerOffset(outUpstreamZ[1],0),angIdx) << endl;
            //  cout << endl;
...
void SimpleCornerBalance::solveAngularFlux(cube * aFlux,\
  ...
  double mu = mesh->quadrature[iXi].quad[iXi][1];
